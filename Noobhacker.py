...
logo='''
 ...
 | |\/| | / /\ \ |  __|   | |   \   // /\ \
 | |  | |/ ____ \| |     _| |_   | |/ ____ \
 |_|  |_/_/    \_\_|    |_____|  |_/_/    \_\(MAFIYA KING)V.2

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ CODER     : @blackhacker890✅
\033[1;95m☞ EMAIL    : mafiyasourav61@gmail.com 
...
def menu():
	...
	print (S + 50*'-')
	print
	print (S + '[' + P + '☞1' + S + ']' + S + ' Mafiya New Update Cloning')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Noobhacker')
	    os.system('cd $HOME && git clone https://github.com/Blackhacker890/Noobhacker.git')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WellCome To Mafiya Tool')
	    psb('Congratulations Nabil Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ Mafiya✓')
	    psb('🔓Password ☆ Hunter✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/Cloner-V2 && python2 Noobhacker.py')
	elif bm =='3':
